...
# Мы получим ошибку: TypeError: MyClass() takes no arguments
...
Всё, что угодно является объектом в Python: 
...
их для простого изменения классов. Это можно делать двумя другими способами:
-руками
-декораторами классов
